// Source: https://github.com/Developer-Mike/obsidian-advanced-canvas/blob/main/src/%40types/Obsidian.d.ts#L33
...
declare module "obsidian" {
  export default interface App {
    ...
    workspace: Omit<Omit<ExtendedWorkspace, 'on'>, 'trigger'> & {
      on<K extends keyof CanvasEvents>(name: K, callback: (...args: Parameters<CanvasEvents[K]>) => void): EventRef
      trigger<K extends keyof CanvasEvents>(name: K, ...args: Parameters<CanvasEvents[K]>): void
